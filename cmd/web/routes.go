...
func (app *application) routes() http.Handler {
	...
	m.Handle("/snippet/create", app.session.Enable(app.RequireAuthentication(http.HandlerFunc(app.createSnippetForm)))).
		Methods(http.MethodGet)
	m.Handle("/snippet/create", app.session.Enable(app.RequireAuthentication(http.HandlerFunc(app.createSnippet)))).
	...
	m.Handle("/user/logout", app.session.Enable(app.RequireAuthentication(http.HandlerFunc(app.logoutUser)))).
		Methods(http.MethodPost)
